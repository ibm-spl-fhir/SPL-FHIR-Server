...
public class JpaRestfulServer extends RestfulServer {
    ...
    protected void initialize() throws ServletException {
        ...
        if (fhirVersion == FhirVersionEnum.R4) {
            IResourceProvider establishmentProvider = appCtx.getBean("myEstablishmentProvider", EstablishmentResourceProvider.class);
        	registerProvider(establishmentProvider);
        }
